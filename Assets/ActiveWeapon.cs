...
public class ActiveWeapon : MonoBehaviour
{
    ...
    public void Construct(CinemachineFreeLook cinemachineFree)
    {
        _cinemachineFreeLook = cinemachineFree;
    }
    ...
    public void Equip(RaycastWeapon newWeapon)
    {
        ...
        currentWeaponInSlot.Recoil.Construct( _cinemachineFreeLook,_rigController);
    ...
    private IEnumerator ActivateWeapon(int index)
    {
        ...
        if (weapon)
        {
            ...
            _rigOverrideController["Equip_animation"] = _equipedWeapons[_activeWeaponIndex].WeaponAnimation;//происходит слишком рано? анимация не законце почемуто
            _rigOverrideController["Weapon_reload_empty"] = _equipedWeapons[_activeWeaponIndex].WeaponReload;
