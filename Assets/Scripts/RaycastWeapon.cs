...
public class RaycastWeapon : MonoBehaviour
{
    ...
    private void FireBullet()
    {
        ...
        var bullet = Bullet.Create(_raycastOrigin.position, (_raycastDestinationTarget.position - _raycastOrigin.position).normalized * _bulletSpeed,_BulletTracerEffect);
        _bullets.Add(bullet);
    }
    ...
    private void Awake()
    {
        _raycastDestinationTarget = Camera.main.transform.Find("CameraTarget");
